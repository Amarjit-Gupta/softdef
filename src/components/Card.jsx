...
export const Card1 = () => {
  return (
    <div className="relative rounded-[40px] h-197 lg:h-110 w-79 lg:w-200 flex flex-col lg:flex-row mt-15 lg:mt-10 m-auto justify-between items-center bg-[#262c23] transform transition-all duration-500 hover:scale-101 hover:shadow-lg hover:-translate-y-1  hover:shadow-black/40">
